...
export default function WorkshopLanding() {
  return (
    <main className="min-h-screen bg-[#f5f9f8] text-slate-950">
        ...
        <div className="mx-auto grid max-w-[1320px] gap-12 lg:grid-cols-[.86fr_1.14fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-xl text-xs leading-5 text-slate-500">
              Registration and payment are connected to your PsyLattice account. Exact session timings, meeting information and the detailed brochure are shared privately after confirmed registration.
            </p>
          </div>
      ...
      <section id="certificate-verification" className="scroll-mt-28 border-y border-slate-200 bg-white px-5 py-20 sm:px-6 lg:px-8">
      ...
      <section className="px-5 pb-20 sm:px-6 lg:px-8">
        <div className="relative mx-auto max-w-[1320px] overflow-hidden rounded-[34px] bg-slate-950 p-8 text-white sm:p-10 lg:p-12">
          ...
          <div className="relative flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            ...
            <Link href="/workshops/register" className="inline-flex w-fit items-center gap-2 rounded-xl bg-white px-5 py-3 text-sm font-semibold text-slate-950 transition hover:-translate-y-px">
              Register now
              <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
