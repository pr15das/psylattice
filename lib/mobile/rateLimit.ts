...
export const MOBILE_RATE_LIMITS = {
  ...
  participantReads: { limit: 300, windowMs: 10 * 60 * 1000 },
  participantMutations: { limit: 300, windowMs: 10 * 60 * 1000 },
  sensorEvents: { limit: 300, windowMs: 10 * 60 * 1000 },
  researcherReads: { limit: 300, windowMs: 10 * 60 * 1000 },
  researcherMutations: { limit: 60, windowMs: 10 * 60 * 1000 },
